...
async function loadSettings() {
    try {
        ...
        return { enabled: false, rate: 1.1, voice: null, engine: 'webspeech', voxtralUrl: 'http://localhost:18000', voxtralApiKey: '', voxtralVoice: 'casual_male', voxtralVoiceSource: 'preset' };
    }
}
